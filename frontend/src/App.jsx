      ...
      <Routes>
        ...
        <Route element={<AdminLayout />}>
          <Route
            ...
            element={<Navigate to="/admin/secoes" replace />}
          />
          <Route path="/admin/secoes" element={<GerirSecoes />} />
          <Route path="/admin/banners" element={<GerirBanners />} />

          <Route
            path="/admin/educadores/candidaturas"
            element={<NovasCandidaturas />}
          />
          <Route
            path="/admin/educadores/cadastrados"
            element={<EducadoresCadastrados />}
          />
        </Route>
