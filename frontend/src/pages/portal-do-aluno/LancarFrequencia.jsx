...
export default function LancarFrequencia() {
    ...
    const [presencas, setPresencas] = useState([
        { aluno: "Fulano", presenca: "P", justificativa: "" },
        { aluno: "Ciclano", presenca: "F", justificativa: "" },
        { aluno: "Beltrano", presenca: "FJ", justificativa: "Aluno doente" },
    ]);
    ...
    function handleSave() {
        ...
        setIsEdit(false);
        navigate("/portal/lancar-frequencia");
    }
